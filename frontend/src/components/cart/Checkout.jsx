...
function Checkout() {
    ...
    // Ensure cart is loadde before proceeding
    useEffect(() => {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-7xl mx-auto py-10 px-6 tracking-tighter">
            ...
            <div className="bg-white rounded-lg p-6">
                ...
                <form onSubmit={handleCreateCheckout}>
                    ...
                    {/* Address */}
                    <div className="mb-4">
                        <label className="block text-gray-700">Addresse</label>
                        <input
                            type="text"
                        ...
                        {!checkoutId ? (
                            ...
                            <div>
                                ...
                                <PaypalButton
                                    ...
                                    onError={(err) => alert("Payement Failed. Try again later.")}
                                />
                            </div>
                        )}
                    </div>
                ...
                <div className="border-t py-4 mb-4">
                    {cart.products.map((product, index) => (
                        ...
                        >
                            ...
                            <p className="text-xl">$ {(product.quantity * product.price)?.toLocaleString()}</p>
                        </div>
                    ))}
                </div>
